...
{	
	...
	string x[5] = { "brian", "lois", "meg", "peter", "quagmire" };
	string y[4] = { "chris", "lois", "lois", "stewie" };
	string z[20];
	int n = mingle(x, 5, y, 4, z, 20);
	string q[5] = { "a", "b", "c", "d", "e" };
	string w[4] = { "a", "b", "c", "d" };
	string e[20];
	int c = mingle(q, 5, w, 4, e, 20);
	cerr << c << endl;
	//assert(divide(h, 7, "meg") == 3);
	string Z[6] = { "brian", "meg", "quagmire", "chris", "stewie", "lois" };
	cerr << divide(Z, 6, "peter") << endl;
	string J[4] = { "peter", "meg", "stewie", "lois" };
	cerr << divide(J, 4, "meg") << endl;  
